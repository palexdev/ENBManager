...
package io.github.palexdev.enbmanager.backend.fp;

import io.github.palexdev.enbmanager.backend.fp.Functions.*;
...
public interface Tuple {
    ...
    static <T1, T2, T3, T4, T5> Tuple5<T1, T2, T3, T4, T5> tuple(
        ...
        record tuple5<T1, T2, T3, T4, T5>(T1 param1, T2 param2, T3 param3, T4 param4,
                                          T5 param5) implements Tuple5<T1, T2, T3, T4, T5> {
            @Override
    ...
    static <T1, T2, T3, T4, T5, T6, T7> Tuple7<T1, T2, T3, T4, T5, T6, T7> tuple(
        ...
        record tuple7<T1, T2, T3, T4, T5, T6, T7>(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6,
                                                  T7 param7)
    ...
    static <T1, T2, T3, T4, T5, T6, T7, T8> Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> tuple(
        ...
        record tuple8<T1, T2, T3, T4, T5, T6, T7, T8>(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6,
                                                      T7 param7, T8 param8)
    ...
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9> Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> tuple(
        ...
        record tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5,
