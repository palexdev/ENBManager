...
import io.github.palexdev.enbmanager.backend.fp.Functions.FN1;
...
import static io.github.palexdev.enbmanager.backend.fp.Option.none;
import static io.github.palexdev.enbmanager.backend.fp.Option.some;
...
public final class Causes {
    ...
    public static final Cause EMPTY = new SimpleCause("empty", none());
    public static final Cause EXISTING = new SimpleCause("existing", none());
